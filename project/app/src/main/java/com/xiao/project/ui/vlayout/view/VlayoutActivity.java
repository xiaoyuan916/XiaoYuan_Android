package com.xiao.project.ui.vlayout.view;
...
import com.xiao.project.ui.vlayout.adapter.BannerLayoutAdapter;
import com.xiao.project.ui.vlayout.adapter.GridLayoutAdapter;
import com.xiao.project.ui.vlayout.adapter.HorizontalListLayoutAdapter;
import com.xiao.project.ui.vlayout.adapter.ListLayoutAdapter;
import com.xiao.project.ui.vlayout.adapter.StickyTitleAdapter;
import com.xiao.project.ui.vlayout.model.ItemBean;
import com.xiao.project.ui.vlayout.model.ModelBean;
...
public class VlayoutActivity extends AppCompatActivity {
                ...
                case "banner":
                    ...
                    bannerLayoutAdapter.setBannerCallback(new BannerLayoutAdapter.BannerCallback() {
                        ...
                        public void clickBanner(ItemBean itemBean) {
                            Toast.makeText(VlayoutActivity.this, itemBean.getTitle(), Toast.LENGTH_SHORT).show();
                        }
                    });//设置自定义回调，用于点击事件监听
    ...
    private void getTestDatas() {
        String listdata = getStringFromAssert(VlayoutActivity.this, "vlayout.txt");
        try {

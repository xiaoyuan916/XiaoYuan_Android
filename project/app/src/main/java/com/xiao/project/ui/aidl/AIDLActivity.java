package com.xiao.project.ui.aidl;
...
//        intent.setClassName("com.xxyuan.service.aidl", "AIDLService");
        intent.setAction("com.xxyuan.service.ACTION_AIDL_SERVICE");
        intent.setPackage("com.xxyuan.service");    //从 Android 5.0开始 隐式Intent绑定服务的方式已不能使用,所以这里需要设置Service所在服务端的包名

package com.xiao.project.ui.gesturelock;
...
public class FingerprintGestureActivity extends AppCompatActivity {
    private static final String TAG = "FingerprintGesture";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fingerprint_gesture);
        initView();
        initClickListener();
    }
    ...
    private void initClickListener() {
        ...
        mStartFingerPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAlertDialog = new SweetAlertDialog(FingerprintGestureActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                        .setTitleText("指纹验证!")
                ...
                mFingerprintIdentify.startIdentify(3, new BaseFingerprint.FingerprintIdentifyListener() {
                    ...
                    public void onSucceed() {
                        ...
                        Toast.makeText(FingerprintGestureActivity.this, "onSucceed", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onNotMatch(int availableTimes) {
                        ...
                        Toast.makeText(FingerprintGestureActivity.this, "onNotMatch", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onFailed() {
                        ...
                        Toast.makeText(FingerprintGestureActivity.this, "onFailed", Toast.LENGTH_SHORT).show();
                        mFingerprintIdentify.cancelIdentify();
                    }
                });
            }
        ...
        mInitGestureUnlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GestureUnlock.getInstance().init(FingerprintGestureActivity.this.getApplicationContext());
                GestureUnlock.getInstance().createGestureUnlock(FingerprintGestureActivity.this);
            }
        });
        // 验证手势密码事件
        mVerifyGestureUnlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GestureUnlock.getInstance().init(FingerprintGestureActivity.this.getApplicationContext());
                GestureUnlock.getInstance().verifyGestureUnlock(FingerprintGestureActivity.this);
            }
        });
        // 修改手势密码
        mModifyGestureUnlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GestureUnlock.getInstance().init(FingerprintGestureActivity.this.getApplicationContext());
                GestureUnlock.getInstance().modifyGestureUnlock(FingerprintGestureActivity.this);
            }
        });
    }

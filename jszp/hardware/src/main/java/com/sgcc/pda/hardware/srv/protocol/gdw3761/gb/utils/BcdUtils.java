...
package com.sgcc.pda.hardware.srv.protocol.gdw3761.gb.utils;
...
public class BcdUtils {
    ...
    public static byte stringToByte(String str) {
        return (byte) (BcdUtils.charToByte(str.charAt(0)) * 0x10 + BcdUtils.charToByte(str.charAt
                (1)));
    }
    ...
    public static String byteToBitSetString(byte[] bytes) {
        StringBuilder sb = new StringBuilder();
        ...
        String dex[] = sb.toString().split("");
        for (int i = dex.length - 1; i > 0; i--) {
            sb2.append(dex[i]);
        }
        return sb2.toString();
    }

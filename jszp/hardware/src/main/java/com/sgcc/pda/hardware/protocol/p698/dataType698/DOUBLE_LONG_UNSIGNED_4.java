...
/**
 * 处理DOUBLE_LONG类型，当字节数组不够4个补齐(保留4位小数)
 * 
 * @author zhm
 *
 */
public class DOUBLE_LONG_UNSIGNED_4 extends IPharesItem698 {

	@Override
	public String getResStr() {
		// byte[] bytes = {0, 4, 6, 103};
		byte[] bytes = this.getUpbyte();
		String hexStr = CommUtils.bytesToHexString(bytes);
		double tempVal = Double.valueOf(Integer.parseInt(hexStr, 16)) / 10000;
		if (tempVal == 0)
			return "0.0000";
		else
...
//			String dl2Str = "263783".replace(".", "");
	...
	public static void main(String[] args) {
		DOUBLE_LONG_UNSIGNED_4 dlu4 = new DOUBLE_LONG_UNSIGNED_4();
		dlu4.getBytes();
		System.out.println(dlu4.getResStr());
	}
}

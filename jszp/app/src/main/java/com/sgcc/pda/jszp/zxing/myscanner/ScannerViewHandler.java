...
package com.sgcc.pda.jszp.zxing.myscanner;
...
import com.sgcc.pda.jszp.zxing.myscanner.camera.CameraManager;
import com.sgcc.pda.jszp.zxing.myscanner.common.Scanner;
import com.sgcc.pda.jszp.zxing.myscanner.decode.DecodeThread;


/**
 * 针对扫描任务的Handler，可接收的message有启动扫描（restart_preview）、扫描成功（decode_succeeded）、扫描失败（decode_failed）等等
 * This class handles all the messaging which comprises the state device for
 * capture.
 *

...
public class DeviceOutDetailActivity2 extends BaseActivity implements ScanOutFragment.OnCountChangedListener{
    ...
    public int getLayoutResId() {
        return R.layout.activity_device_out_detail2;
    }

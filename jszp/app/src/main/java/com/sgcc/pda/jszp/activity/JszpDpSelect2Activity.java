...
import static com.sgcc.pda.jszp.adapter.JSZPDpSelectAdapter.SELECT_DP_OPTION_REQUEST_3;

public class JszpDpSelect2Activity extends BaseActivity {
    /**
     * 响应码
     */
    ...
    public int getLayoutResId() {
        return R.layout.activity_jszp_dp_select2;
    }

    @Override
    public void initView() {
        adapter = new JSZPDpSelectAdapter(this, 2);
    ...
    public void initData() {
        ...
        JszpDpInfoController.obtainCompanyData(this, mHandler,
                QUERY_SUB_WH_AND_DP_WHAT, jszpOrgListEntity,"04");
    }

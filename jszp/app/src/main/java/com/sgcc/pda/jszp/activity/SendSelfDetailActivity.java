 ...
 * 自提出发详情界面
 */
public class SendSelfDetailActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case GET_CONFIRM_WHAT://发车成功
                    Toast.makeText(SendSelfDetailActivity.this, "发车成功!", Toast.LENGTH_SHORT).show();
                    setResult(403);
                    finish();
                    break;
    ...
    public void initView() {
        tvTitle.setText("自提出发");
        tvWuLiu.setText("自提出发");
    ...
    private void getDetailData() {
        ...
        JSZPOkgoHttpUtils.postString(JSZPUrls.URL_GET_WAIT_START_TAKE_TASK,
                this, map,

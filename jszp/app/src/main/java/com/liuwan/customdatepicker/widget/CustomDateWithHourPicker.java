 ...
 */
public class CustomDateWithHourPicker {
    ...
    public CustomDateWithHourPicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.custom_date_picker_with_hour);

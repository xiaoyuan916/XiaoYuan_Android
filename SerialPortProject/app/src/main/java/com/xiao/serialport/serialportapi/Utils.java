...
public class Utils {
	...
	public static String crcTable(byte[] bytes) {
		...
		return DigitalTrans.byte2hex(a);
	}
	...
	/**
	 * 长度为3的字节数组（高位在前，低位在后）转换为long类型的值。
	 * 
	 * @author NY
	 * 
	 * @param src
	...
	public static long bytes2Long(byte[] src) {
		long value;
		value = (long) (((src[0] & 0xFF) << 16) | ((src[1] & 0xFF) << 8) | (src[2] & 0xFF));
		return value;
	}

	public static void main(String[] args) {
		String a = "242424247F11110002304231321C01";
		System.out.println(crcTable(DigitalTrans.hex2byte(a)));
	}
